  ...
  return (
    ...
    >
      <input
        ...
        className="placeholder:text-neutral-400 text-sm pl-[30px] flex-1 rounded-full self-stretch"
        required
        name="keyword"
        {...props}
      />
      ...
      <Button
        className="rounded-full h-9 w-auto px-4 text-center text-[13px] text-white"
        loading={loading}
      >
        Tìm
      </Button>
